...
const headCells = [
  ...
  { id: "decline", numeric: false, disablePadding: false, label: "Decline" },
...
export default function CompanyTable() {
  ...
  const getEventsList = async () => {
    ...
    const filteredUsers = response.filter(
      (approved) => approved.isApproved === false
    );
    setEvents(filteredUsers);
  };
  ...
  const handleApprove = async (id) => {
    ...
    try {
      ...
      setTimeout(() => {
        // history.push("/company/events");
        history.go("/admin/approvedRequests");
      }, 500);
    } catch (e) {}
  };
