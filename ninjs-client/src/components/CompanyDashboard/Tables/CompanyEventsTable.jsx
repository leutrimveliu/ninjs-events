...
export default function CompanyEventsTable() {
  ...
  //     (event) => currentUser.user._id === event.user_id
  //   );
  ...
  //   const response = await getEventsBooking(currentUser.user._id);
  //   console.log(response)
  //   setPaymentVal(response)
  // };
          ...
          <TableBody>
            {stableSort(events, getComparator(order, orderBy))
              ...
              .map((event, index) => {
                ...
                // if (currentUser.user._id === event.user_id) {
                return (
                  <TableRow
                    hover
